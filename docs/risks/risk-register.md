...
|---|---|---|
| R-001 | Coverage is central but undefined, so quality claims may be arbitrary. | Establish hypotheses, expert evidence, and an attested computation before authoritative reporting. |
